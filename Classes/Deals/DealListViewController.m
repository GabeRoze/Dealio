...
- (void)viewDidLoad
{
    ...
    //saturdaybutton.canBecomeFirstResponder = YES;
    ...
    //DayControlBar* dayBar = [[DayControlBar alloc] init];
    //[self.view.superview addSubview:dayBar];
    
    //[self.view.superview insertSubview:dayBar.view aboveSubview:self.view];
    
    /*
     dayControlBar = [[UISegmentedControl alloc] initWithItems:nil];
     [dayControlBar insertSegmentWithImage:[UIImage imageNamed:@"sun.png"] atIndex:0 animated:YES];
     [dayControlBar insertSegmentWithImage:[UIImage imageNamed:@"m.png"] satIndex:1 animated:YES];
     [dayControlBar insertSegmentWithImage:[UIImage imageNamed:@"t.png"] atIndex:2 animated:YES];
     [dayControlBar insertSegmentWithImage:[UIImage imageNamed:@"w.png"] atIndex:3 animated:YES];
     [dayControlBar insertSegmentWithImage:[UIImage imageNamed:@"th.png"] atIndex:4 animated:YES];
     [dayControlBar insertSegmentWithImage:[UIImage imageNamed:@"f.png"] atIndex:5 animated:YES];
     [dayControlBar insertSegmentWithImage:[UIImage imageNamed:@"sat.png"] atIndex:6 animated:YES];
     dayControlBar.segmentedControlStyle = UISegmentedControlNoSegment;
     dayControlBar.frame = CGRectMake(-5, 46, 330, 44);
     dayControlBar.backgroundColor = [UIColor clearColor];
     dayControlBar.tintColor = [UIColor clearColor];
     [dayControlBar setMomentary:NO];
     [dayControlBar addTarget:self action:@selector(dayButtonPressed:) forControlEvents:UIControlEventValueChanged];
     [self.view addSubview:dayControlBar];
    ...
    //NSLog(@"today is: %i",weekday);
    
    //Highlight correct day
    //days are from 1-7 :: segments are from 0-6
    [self selectDay:(weekday-1)];
    //[dayControlBar setSelectedSegmentIndex:weekday-1];
